...
const ChartTooltipContent = React.forwardRef(({ payload, className, indicator = "dot", hideLabel = false, hideIndicator = false, label, labelFormatter, labelClassName, formatter, color, nameKey, labelKey, }, ref) => {
    ...
    const tooltipLabel = React.useMemo(() => {
        ...
        const configValue = config[label]?.label || label;
        ...
        return <div className={(0, utils_1.cn)("font-medium", labelClassName)}>{finalValue}</div>;
    }, [
        label,
        labelFormatter,
        payload,
